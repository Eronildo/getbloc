  ...
  group('Change Tests', () {
    ...
    group('== operator', () {
      test('should return true if 2 Changes are equal', () {
        final changeA = const StateChange<int>(currentState: 0, nextState: 1);
        final changeB = const StateChange<int>(currentState: 0, nextState: 1);
    ...
    group('hashCode', () {
      test('should return correct hashCode', () {
        final change = const StateChange<int>(currentState: 0, nextState: 1);
        expect(
          change.hashCode,
  ...
  group('Transition Tests', () {
    group('constructor', () {
      test(
        ...
        expect(
          () => TransformController<TransitionEvent, TransitionState?>(
            currentState: null,
    ...
    group('== operator', () {
      test('should return true if 2 Transitions are equal', () {
        final transitionA = TransformController<CounterEvent, CounterState>(
          currentState: CounterState(0),
          event: CounterEvent('increment'),
          nextState: CounterState(1),
        );
        final transitionB = TransformController<CounterEvent, CounterState>(
          currentState: CounterState(0),
          event: CounterEvent('increment'),
          nextState: CounterState(1),
        );
    ...
    group('hashCode', () {
      test('should return correct hashCode', () {
        final transition = TransformController<CounterEvent, CounterState>(
          currentState: CounterState(0),
          event: CounterEvent('increment'),
          nextState: CounterState(1),
        );
